...
def iniciar_juego():
    ...
    #Cambiar Icono
    icono=pygame.image.load(r"imagenes/tomate.png")
    pygame.display.set_icon(icono)
    #Fondo de pantalla

    fondo_image=pygame.image.load(r'imagenes/pista2.png').convert()
    ...
    # Carga de imágenes
    player_image = pygame.image.load(r'imagenes/player2.jpg')
    player_rect = player_image.get_rect()
    player_rect.y = size[1] - player_rect.height - 50

    obstacle_image = pygame.image.load(r'imagenes/hick3.jpg')
    ...
    while running:
        ...
        obstacle_rect.x -= 3+(tiempo_transcurrido*0.5)*dificultad
